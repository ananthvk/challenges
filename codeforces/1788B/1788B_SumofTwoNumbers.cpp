...
{
    // On observation, it can be noted that for any n, the solution is n and n - n/2
    // But with an exception that if the number ends with a 9, this solution is not valid
