...
void solve(ll test_case_number)
{
    ...
    // 1. n should always be present at position 1
    // One possible solution is [n, 1, n-2, 3, n-4, 5 .... n-1, 2] (from the editorial)
    // How did they find out this pattern?
    // I found that if n > 1 and n is odd, there is no solution
    ll seq1 = n;
