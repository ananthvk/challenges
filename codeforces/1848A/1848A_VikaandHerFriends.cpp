...
{
    // Consider the mall like a chess board
    // If vika is on one color and all her friends are on another color, they can never catch her
    // Since after every move, they will always be one color apart
    ll n = readn();
    ll m = readn();
    ll k = readn();
    ll vx = readn();
